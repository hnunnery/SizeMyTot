...
// closing mobile navigation when clicking link
let calculatorLink = document.querySelector(".calculator");
calculatorLink.addEventListener("click", closeNav);
...
function outputSizes() {
  ...
  document.getElementById(
    "freshlyPickedSoftSolesOutput"
  ).innerHTML = `FP Soft Soles: ${freshlyPickedSoftSoles}`;

  document.getElementById(
    "freshlyPickedSandalsOutput"
  ).innerHTML = `FP Sandals: ${freshlyPickedSandals}`;

  document.getElementById(
    "miniMelissaOutput"
  ).innerHTML = `Mini Melissa: ${miniMelissa}`;

  document.getElementById("nativeOutput").innerHTML = `Native: ${native}`;

  document.getElementById(
    "newBalanceOutput"
  ).innerHTML = `New Balance: ${newBalance}`;
  ...
  document.getElementById(
    "seeKaiRunOutput"
  ).innerHTML = `See Kai Run: ${seeKaiRun}`;

  document.getElementById(
    "strideRiteOutput"
  ).innerHTML = `Stride Rite: ${strideRite}`;
